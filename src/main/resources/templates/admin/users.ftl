...
<#-- Dodanie arkusza stylów dla admina -->
...
<div class="content-wrapper d-flex flex-column align-items-center px-2" style="min-height: 100vh; padding-top: 80px;">
    <div class="login-container" style="max-width: 1200px; width: 95%;">
        ...
        <td class="admin-actions">
            <form action="/admin/users/${user.id}/role" method="post" class="d-flex">
                <select name="role" class="me-2">
                    ...
                    <option value="${r}" <#if user.roles?seq_contains(r)>selected</#if>>${r}</option>
                </#list>
                </select>
...
<div style="text-align: center; margin-top: 20px;">
    <a href="/" class="open_chat" style="padding: 10px 20px; font-size: 1rem;">
