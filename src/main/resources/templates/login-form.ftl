        ...
        <div class="single-page-container">
            <div class="content-wrapper  px-2">
                <div class="login-container panel">
                    ...
                    <h6>
                        <@spring.message "login.register.heading" />
                    </h6>
                    ...
                    <div id="termsModal" class="modal">
                        <div class="modal-content">
                            <h3>
                                <@spring.message "modal.heading" />
                            </h3>
                            <p>
                                <@spring.message "modal.intro" />
                                ...
                                <div>
                                    <button id="acceptAndContinue" disabled>
                                        <@spring.message "modal.continue" />
                                    </button>
                                    <button onclick="closeModal()">
                                        <@spring.message "modal.cancel" />
                                    </button>
                                </div>
                            </div>
                        </div>
