    ...
    <div class="chat-container">
        ...
        <div class="chat-input">
            ...
            <button id="send-button" class="send-button" onclick="window.inputView.makeChat()">
                ...
                <div id="stop-icon" class="d-flex align-items-center justify-content-center d-none">
                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="12" viewBox="0 0 384 512">
                        <path fill="#ffffff"
                              d="M0 96C0 60.7 28.7 32 64 32H320c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"/>
                    </svg>
                </div>
            </button>
        </div>
