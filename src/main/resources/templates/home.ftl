...
<body>
    <div class="center" style="height: 100vh;">
        ...
        <div class="file-browser mt-1" style="background: rgba(45,45,49,0.8); padding: 20px; border-radius: 10px;">
            ...
            <div class="file-grid" style="grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 20px;">
                <div class="file-item" style="text-align: center;">
                    <div class="icon-file" style="font-size: 3rem; margin-bottom: 10px;"> <i class="fas fa-search-plus"></i> </div> <!-- Ikona lupy z plusem -->
                ...
                <div class="file-item" style="text-align: center;">
                    <div class="icon-file" style="font-size: 3rem; margin-bottom: 10px;"> <i class="fas fa-sliders-h"></i> </div> <!-- Ikona suwaków/ustawień -->
                ...
                <div class="file-item" style="text-align: center;">
                    <div class="icon-file" style="font-size: 3rem; margin-bottom: 10px;"> <i class="fas fa-magic"></i> </div> <!-- Ikona magicznej różdżki -->
