...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    public SecurityConfig(CustomOAuth2UserService customOAuth2UserService, RateLimitingFilter rateLimitingFilter, CustomAuthenticationSuccessHandler customAuthenticationSuccessHandler) {
